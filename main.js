...
function myKeyDown(e)
{
	...
	function up()
	{
		...
		console.log("Quando a tecla direcional cima é pressionada,  =  " + ball_y + " , X = " +ball_x);
		canvas.remove(ball_obj);
		newImage();
	...
	function left()
	{
		if(ball_x >5)
		{
			ball_x = ball_y + block_image;
			console.log("Quando a tecla direcional esquerda é pressionada,  =  " + ball_y + " , X = " +ball_x);
			canvas.remove(ball_obj);
			newImage();
	...
	function right()
	{
		if(ball_X <=1050)
		{
			ball_y = ball_x + block_image;
			console.log("Quando a tecla direcional direita é pressionada,  =  " + ball_x + " , Y = " +ball_y);
			canvas.remove(ball_obj);
			newImage();
